...
interface BusinessInviteTableProps {
...
const BusinessInviteTable = ({ tableConfig, cardConfig, children, paginationConfig, className, style, tableScrollHeight, footer, needPagination = true }: BusinessInviteTableProps) => {
...
export default BusinessInviteTable;