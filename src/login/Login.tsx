  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md sm:max-w-6xl flex flex-col md:flex-row bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className={`${isMobile ? 'hidden' : 'flex-1'} bg-[rgba(248,213,126,0.05)] p-6 sm:p-12 flex flex-col items-center justify-center`}>
          <div className="flex items-center gap-2 mb-4 sm:mb-8">
            <h1 className="text-[rgba(248,213,126,1)] text-xl sm:text-2xl font-medium">LUCY AI</h1>
          </div>
          <img src={loginImage} alt="Login Illustration" className="w-64 sm:w-96 mb-4 sm:mb-8" />
          <h1 className="text-[rgba(248,213,126,1)] text-2xl sm:text-3xl font-semibold">LUCY AI</h1>
          <p className="text-gray-600 mt-2 sm:mt-4 text-sm sm:text-base">企业成功的关键选择</p>
        </div>

        {/* Logo for Mobile View Only */}
        {isMobile && (
          <div className="flex flex-col items-center justify-center py-6 bg-[rgba(248,213,126,0.05)]">
            <h1 className="text-[rgba(248,213,126,1)] text-3xl font-semibold">LUCY AI</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div>
                <input
                  ...
                  required
                  placeholder="请输入邮箱地址"
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgba(248,213,126,0.2)] focus:border-[rgba(248,213,126,1)] transition-colors text-sm sm:text-base"
                  value={email}
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="remember-me"
                  className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[rgba(248,213,126,1)] focus:ring-[rgba(248,213,126,1)] border-gray-300 rounded"
                  checked={rememberMe}
              ...
              <button
                type="submit"
                className="w-full bg-[rgba(248,213,126,1)] text-white rounded-lg py-2.5 sm:py-3 hover:bg-[rgba(248,213,126,0.9)] transition-colors disabled:opacity-50 text-sm sm:text-base"
                disabled={loading}
              >
                {loading ? '登录中...' : '登录'}
              </button>
            ...
            <div className="text-center mt-4">
              <p className="text-xs sm:text-sm text-gray-600">
                ...
                <button
                  ...
                  className="font-medium text-[rgba(248,213,126,1)] hover:text-[rgba(248,213,126,0.8)]"
                >
                  立即注册
                </button>
              </p>
